...
#srun --cpu-bind=rank ./cmake-build-debug/ddalphaamg --gtest_filter=DiracTest.MeasurementTest ./sample128.ini

srun --cpu-bind=rank ./cmake-build-debug/ddalphaamg --gtest_filter=BlockTest.*Solve ./sample128.ini

#srun --cpu-bind=rank ./cmake-build-debug/ddalphaamg --gtest_filter=OETest.CheckSchurComplement ./sample128.ini
