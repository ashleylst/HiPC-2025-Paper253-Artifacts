...
void d_plus_clover_aggregate_double_vectorized(complex_double *eta1, complex_double *eta2,
  ...
  spin0and1_site_clover_double_vectorized(eta1, phi + site_offset * site, s->op.clover + 42 * site,
                                          4 + s->op.m0, offset);
  spin2and3_site_clover_double_vectorized(eta2, phi + site_offset * site, s->op.clover + 42 * site,
                                          4 + s->op.m0, offset);
...
void diagonal_aggregate_double_vectorized(complex_double *eta1, complex_double *eta2,
  ...
  sse_diagonal_aggregate_double(eta1, eta2, phi + site_offset * site, s->op.odd_proj + 12 * site,
                                offset);
}
#endif
