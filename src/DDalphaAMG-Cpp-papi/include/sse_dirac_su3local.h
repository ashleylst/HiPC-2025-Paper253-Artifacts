...
#define CURRENT_MADD cfmadd
...

    {
      ...
      res11[1] = _mm_setr_ps(index_d_re(pt, MU, 0), index_d_re(pt + 2, MU, 0),
                             index_d_re(pt + 4, MU, 0), 0);
      res21[0] = _mm_setr_ps(pt[1], pt[3], pt[5], 0);
      res21[1] = _mm_setr_ps(index_d_im(pt, MU, 0), index_d_im(pt + 2, MU, 0),
                             index_d_im(pt + 4, MU, 0), 0);
      ...
      res11[1] = _mm_setr_ps(index_d_re(pt, MU, 1), index_d_re(pt + 2, MU, 1),
                             index_d_re(pt + 4, MU, 1), 0);
      res21[0] = _mm_setr_ps(pt[7], pt[9], pt[11], 0);
      res21[1] = _mm_setr_ps(index_d_im(pt, MU, 1), index_d_im(pt + 2, MU, 1),
                             index_d_im(pt + 4, MU, 1), 0);
      ...
      res12[1] = _mm_setr_ps(index_d_re(pt + 12, MU, 0), index_d_re(pt + 14, MU, 0),
                             index_d_re(pt + 16, MU, 0), 0);
      res22[0] = _mm_setr_ps(pt[13], pt[15], pt[17], 0);
      res22[1] = _mm_setr_ps(index_d_im(pt + 12, MU, 0), index_d_im(pt + 14, MU, 0),
                             index_d_im(pt + 16, MU, 0), 0);
      ...
      res12[1] = _mm_setr_ps(index_d_re(pt + 12, MU, 1), index_d_re(pt + 14, MU, 1),
                             index_d_re(pt + 16, MU, 1), 0);
      res22[0] = _mm_setr_ps(pt[19], pt[21], pt[23], 0);
      res22[1] = _mm_setr_ps(index_d_im(pt + 12, MU, 1), index_d_im(pt + 14, MU, 1),
                             index_d_im(pt + 16, MU, 1), 0);
    ...
    { // store result
...
#endif
      {
        ...
        { // store contribution from 1st SU(3) multiplication to either spin2 or spin3
          ...
          *buf[gamma_offset[MU][0]] =
              _mm_set1_ps(CURRENT_SIGN * gamma_re_sign[MU][gamma_co[MU][0]]);
          *buf[1 - gamma_offset[MU][0]] =
              _mm_set1_ps(CURRENT_SIGN * gamma_im_sign[MU][gamma_co[MU][0]]);
        ...
        { // store contribution from 1st SU(3) multiplication to either spin2 or spin3
          __m128 *buf[2] = {&buf3, &buf4};
          *buf[gamma_offset[MU][1]] =
              _mm_set1_ps(CURRENT_SIGN * gamma_re_sign[MU][gamma_co[MU][1]]);
          *buf[1 - gamma_offset[MU][1]] =
              _mm_set1_ps(CURRENT_SIGN * gamma_im_sign[MU][gamma_co[MU][1]]);
...
#define CURRENT_MADD cfmadd
    ...
    double *pt = phi + 24 * neighbor[4 * ind[i] + MU];
      ...
      res1[1] =
          _mm_setr_ps(index_re(pt, MU, 0), index_re(pt + 2, MU, 0), index_re(pt + 4, MU, 0), 0);
      res2[0] = _mm_setr_ps(pt[1], pt[3], pt[5], 0);
      res2[1] =
          _mm_setr_ps(index_im(pt, MU, 0), index_im(pt + 2, MU, 0), index_im(pt + 4, MU, 0), 0);
      ...
      res1[1] =
          _mm_setr_ps(index_re(pt, MU, 1), index_re(pt + 2, MU, 1), index_re(pt + 4, MU, 1), 0);
      res2[0] = _mm_setr_ps(pt[7], pt[9], pt[11], 0);
      res2[1] =
          _mm_setr_ps(index_im(pt, MU, 1), index_im(pt + 2, MU, 1), index_im(pt + 4, MU, 1), 0);
