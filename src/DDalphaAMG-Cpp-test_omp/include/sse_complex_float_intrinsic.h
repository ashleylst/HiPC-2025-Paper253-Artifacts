...
// c = a*b
static inline void cmul(__m128 a_real, __m128 a_imag, __m128 b_real, __m128 b_imag, __m128 *c_real,
                        __m128 *c_imag) {
...
// c = -a*b
static inline void cnmul(__m128 a_real, __m128 a_imag, __m128 b_real, __m128 b_imag, __m128 *c_real,
                         __m128 *c_imag) {
  *c_real = _mm_mul_ps(a_imag, b_imag);
  *c_imag = _mm_mul_ps(a_imag, b_real);
...
// c = conj(a)*b
static inline void cmul_conj(__m128 a_real, __m128 a_imag, __m128 b_real, __m128 b_imag,
...
// c = -conj(a)*b
static inline void cnmul_conj(__m128 a_real, __m128 a_imag, __m128 b_real, __m128 b_imag,
                              __m128 *c_real, __m128 *c_imag) {
  *c_real = _mm_mul_ps(a_imag, b_imag);
  *c_imag = _mm_mul_ps(a_imag, b_real);
...
// c = a*b + c
static inline void cfmadd(__m128 a_real, __m128 a_imag, __m128 b_real, __m128 b_imag,
                          __m128 *c_real, __m128 *c_imag) {
...
// c = -a*b + c
static inline void masked_cfnmadd(__m128 a_real, __m128 a_imag, __m128 b_real, __m128 b_imag,
...
// c = -a*b + c
static inline void cfnmadd(__m128 a_real, __m128 a_imag, __m128 b_real, __m128 b_imag,
                           __m128 *c_real, __m128 *c_imag) {
  __m128 minus_a_real;
  __m128 minus_a_imag;
  minus_a_real = _mm_setzero_ps();
...
// c = conj(a)*b + c
static inline void cfmadd_conj(__m128 a_real, __m128 a_imag, __m128 b_real, __m128 b_imag,
                               __m128 *c_real, __m128 *c_imag) {
...
// c = -conj(a)*b + c
static inline void cfnmadd_conj(__m128 a_real, __m128 a_imag, __m128 b_real, __m128 b_imag,
                                __m128 *c_real, __m128 *c_imag) {
  __m128 minus_a_real;
  __m128 minus_a_imag;
  minus_a_real = _mm_setzero_ps();
...
static inline void sse_complex_deinterleaved_load(double *data, __m128 *result_re,
                                                  __m128 *result_im) {
