...
// c = a*b
static inline void cmul_pd(__m128d a_real, __m128d a_imag, __m128d b_real, __m128d b_imag,
...
// c = conj(a)*b
static inline void cmul_conj_pd(__m128d a_real, __m128d a_imag, __m128d b_real, __m128d b_imag,
                                __m128d *c_real, __m128d *c_imag) {
  *c_real = _mm_mul_pd(a_imag, b_imag);
  *c_imag = _mm_mul_pd(a_imag, b_real);
...
// c = a*b + c
static inline void cfmadd_pd(__m128d a_real, __m128d a_imag, __m128d b_real, __m128d b_imag,
                             __m128d *c_real, __m128d *c_imag) {
...
// c = conj(a)*b + c
static inline void cfmadd_conj_pd(__m128d a_real, __m128d a_imag, __m128d b_real, __m128d b_imag,
                                  __m128d *c_real, __m128d *c_imag) {
...
static inline void sse_complex_deinterleaved_load_pd(double *data, __m128d *result_re,
                                                     __m128d *result_im) {
  *result_re = _mm_setr_pd(data[0], data[2]);
  *result_im = _mm_setr_pd(data[1], data[3]);
}

static inline void sse_complex_interleaved_store_pd(__m128d data_re, __m128d data_im,
                                                    double *result) {
